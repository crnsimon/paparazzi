...
for i in range(len(images.frame_files)):
    ...
    # Draw the points
    images.draw_circle(points2d_cyberzoo_0[0][0], points2d_cyberzoo_0[0][1], radius=10)
    images.draw_circle(points2d_cyberzoo_1[0][0], points2d_cyberzoo_1[0][1], radius=10)
    images.draw_circle(points2d_cyberzoo_2[0][0], points2d_cyberzoo_2[0][1], radius=10)
    images.draw_circle(points2d_cyberzoo_3[0][0], points2d_cyberzoo_3[0][1], radius=10)
    ...
    # Display the image
    images.image_show(waitKeyvalue = 10)
